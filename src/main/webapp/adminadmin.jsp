...
<%
    ...
    int count = HttpService.getAdminNumber();
    ...
    List<UserModel> userModels = HttpService.getAdmins(index);
    if (userModels == null) {
        return;
    }
...
<div class="all">
    ...
    <div class="feature_content">
        ...
        %>
        <div class="sort_tab">
            <table width="600px" style="text-align: center;margin: 0 auto" border="1px" cellspacing="0">
