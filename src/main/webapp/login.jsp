...
<div id="bg">
    ...
    <div id="login_wrap">
        <div id="login"><!-- 登录注册切换动画 -->
            ...
            <span>
                    <form action="post">
                        <p class="form"><input type="text" id="user" placeholder="账户名"></p>
                        <p class="form"><input type="password" id="passwd" placeholder="密码"></p>
                        <p class="form confirm"><input type="password" id="confirm-passwd" placeholder="重复确定密码"></p>
                        <p class="form confirm"><input type="number" id="phone" placeholder="手机号"></p>
